...
\begin{itemize}
    ...
    \item Comparisons involving the arcsine distribution yield the largest K-S values, reflecting its boundary-concentrated CDF, while the truncated normal and uniform distributions exhibit smaller mutual distances due to their more similar cumulative behavior.
